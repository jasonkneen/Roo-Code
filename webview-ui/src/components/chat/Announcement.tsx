	...
	return (
		<div
			...
			<p style={{ margin: "5px 0px" }}>
				Our biggest update yet is here - we're officially changing our name from Synthience Coder to Synthience Coder! After
			...
			<p style={{ margin: "5px 0px" }}>
				...
				the discussion at{" "}
				<VSCodeLink href="https://www.reddit.com/r/SynthienceCoder" style={{ display: "inline" }}>
					reddit.com/r/SynthienceCoder
				</VSCodeLink>
				.
			</p>
		</div>
